...
Note that the script will erase automatically the existing folders containing the evolution of the lattice from previous simulations, be sure to save what you need before proceeding.
## Results
