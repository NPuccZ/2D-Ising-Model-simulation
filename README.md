...
Details and results can be found in the PDF file in the repository. Results are presented for a lattice of dimension 40 x 40, it can be modified by changing the proper line in 2D.cpp, the same holds true for the number of sweeps.
